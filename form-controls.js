...
function initInputs() {
	...
	$("input.numeric-text:not(.account-mask, .vps-account-mask, .money, .org-number-mask, org-number-mask-se, org-number-mask-dk, .date-mask, .phone,  .letteral-text, .ssn-no-mask)").mask('0#');
